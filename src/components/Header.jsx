import src1 from '../assets/img/google-play-badge.svg';
import src2 from '../assets/img/app-store-badge.svg';
                        ...
                        <div className="mb-5 mb-lg-0 text-center text-lg-start">
                            ...
                            <div className="d-flex flex-column flex-lg-row align-items-center">
                                <a className="me-lg-3 mb-4 mb-lg-0" href="#!">
                                    <img className="app-badge" src={src1} alt="Google Play Badge" />
                                </a>
                                <a href="#!">
                                    <img className="app-badge" src={src2} alt="App Store Badge" />
                                </a>
                            </div>
                        </div>
                    </div>
